...
export default function InStock({ inventory = { data: [], links: [], from: 0, to: 0, total: 0 }, filters = { search: '', warehouse_id: '' }, warehouses = [] }) {
    ...
    const debouncedSearch = debounce((value) => {
        router.get(route('admin.inventory.in-stock'), {
            search: value,
                    ...
                    <div className="bg-white/80 backdrop-blur-sm overflow-x-auto shadow-xl rounded-lg">
                        <div className="p-6 min-w-[600px]">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-6">
                                <h1 className="text-2xl font-bold text-[#54483A]">In Stock Inventory</h1>
